...
def get_room_info(room_code):
    ...
    print(f"[DEBUG] Current rooms state before accessing: {rooms}")
    with rooms_lock:
        print(f"[DEBUG] Current rooms state after acquiring lock: {rooms}")
    ...
    with rooms_lock:
        if room_code in rooms and player_name in rooms[room_code]['players']:
            ...
            if not rooms[room_code]['players']:
                ...
                print(f"[DEBUG] Room {room_code} deleted as no players are left")
